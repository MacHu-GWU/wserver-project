...
class BotoSesFactory(aws_ops_alpha.AlphaBotoSesFactory):
    def get_env_role_arn(self, env_name: str) -> str:  # pragma: no cover
        ...
        return f"arn:aws:iam::{aws_account_id}:role/wserver-{env_name}-deployer-us-east-1"
...
boto_ses_factory = BotoSesFactory(
    ...
    env_to_profile_mapper={
        ...
        EnvNameEnum.tst.value: "bmt_app_dev_us_east_1",
        # EnvEnum.stg.value: "bmt_app_dev_us_east_1",
        EnvNameEnum.prd.value: "bmt_app_dev_us_east_1",
    },
