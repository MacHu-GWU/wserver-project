...
from wserver_infra.vendor.aws_ops_alpha.boostrap.multi_account.api import (
    setup_cdk_bootstrap,
...
bsm_tst = BotoSesManager(profile_name="bmt_app_dev_us_east_1")
bsm_prd = BotoSesManager(profile_name="bmt_app_dev_us_east_1")
...
sbx_res_name = f"wserver-sbx-deployer-{bsm_sbx.aws_region}"
tst_res_name = f"wserver-tst-deployer-{bsm_sbx.aws_region}"
prd_res_name = f"wserver-prd-deployer-{bsm_sbx.aws_region}"
...
devops_role_name = "wserver-github-oidc"
devops_stack_name = "wserver-devops-deployer-us-east-1"
devops_policy_name = "wserver-devops-us-east-1"
...
def run_setup_devops_account_s3_bucket():
    setup_devops_account_s3_bucket(
        ...
        workload_account_iam_permission_setup_list=workload_account_iam_permission_setup_list,
        artifacts_s3_prefix="projects/wserver/",
