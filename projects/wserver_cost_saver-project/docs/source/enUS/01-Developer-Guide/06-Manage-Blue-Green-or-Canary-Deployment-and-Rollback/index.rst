...
2. ``wserver_cost_saver/iac/define/lbd.py``: This is the CDK stack code where we declare the ``LIVE`` alias and use the value defined in ``"*.lambda_functions.*.live_version"`` as the target version.

.. literalinclude:: ../../../../wserver_cost_saver/iac/define/lbd.py
   :language: python
